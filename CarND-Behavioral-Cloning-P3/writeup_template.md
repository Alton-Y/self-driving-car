...
My model has a cropping layer (model.py line 74) to remove part of the top and bottom of each frame to reduce the data input size. This also helpst training the model faster with higher precision. 
